...
<input id="spell"  style="width: 100%" value="As the waves crashed against the shore, they carried tales of distant lands and adventures untold." />
<p>Stored Voices</p>
<ul id="stored">
</ul>
...
document.getElementById('btn')?.addEventListener('click', async () => {
    ...
    mainWorker.postMessage({
        type: 'init',
        text: (document.getElementById('spell') as HTMLInputElement).value,
        // @ts-ignore-next-line
